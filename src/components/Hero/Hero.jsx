...
const slideContent = [
  {
    title: "Quiroclínica",
    subtitle:
      "Atendimento personalizado com resultados rápidos e efetivos para dor crônica, reabilitação muscular e bem-estar.",
    buttonText: "Agendar 1ª consulta",
  },
  {
    title: "Transforme sua Saúde",
    subtitle:
      "Tratamentos especializados em quiropraxia e acupuntura. Cuide do seu corpo com quem entende.",
    buttonText: "Quero atendimento",
  },
  {
    title: "Dor nas Costas?",
    subtitle:
      "Nossos tratamentos são focados em resultados duradouros. Agende sua consulta e sinta a diferença.",
    ...
    <section className="hero">
      ...
      <div className="hero-container">
        <div className="hero-content">
          ...
          <button className="hero-cta-btn" onClick={openWhatsApp} type="button">
