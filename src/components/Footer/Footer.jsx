    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-logo">
          <img src="/images/logo-quiro.jpeg" alt={t('footer.logoAlt')} />
        </div>
        ...
        <div className="footer-info">
          ...
          <div className="footer-item" onClick={openWhatsApp} style={{cursor: 'pointer'}}>
            ...
            <p>{t('footer.phone')}: (21) 96592-8971</p>
          </div>
          ...
          <div className="footer-item" onClick={openEmail} style={{cursor: 'pointer'}}>
            ...
            <p>{t('footer.email')}: quiroclinica.quiropraxia@gmail.com</p>
          </div>
      ...
      <div className="footer-bottom">
        <p>
          © {new Date().getFullYear()} Quiroclínica – {t('footer.copyright')}
        </p>
      </div>
    </footer>
  );
